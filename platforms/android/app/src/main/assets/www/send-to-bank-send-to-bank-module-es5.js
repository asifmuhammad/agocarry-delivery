...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["send-to-bank-send-to-bank-module"], {
  ...
  "./src/app/send-to-bank/send-to-bank.page.ts": function srcAppSendToBankSendToBankPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_models_payout_request_models__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/models/payout-request.models */
    "./src/models/payout-request.models.ts");

    var SendToBankPage = /*#__PURE__*/function () {
      function SendToBankPage(navCtrl, translate, uiElementService, apiService) {
      ...
      _createClass(SendToBankPage, [{
        ...
        value: function refreshBalance() {
          ...
          this.subscriptions.push(this.apiService.getBalance().subscribe(function (res) {
            return _this.balance = res.balance;
          }, function (err) {
            return console.log("getBalance", err);
          }));
        }
      }, {
        key: "submit",
        value: function submit() {
          ...
          if (!this.payourRequest.bank_name || !this.payourRequest.bank_name.length) {
            this.translate.get("err_field_bank_name").subscribe(function (value) {
            ...
            this.translate.get("err_field_bank_account_name").subscribe(function (value) {
              return _this2.uiElementService.presentToast(value);
            });
          } else if (!this.payourRequest.bank_account_number || !this.payourRequest.bank_account_number.length) {
            this.translate.get("err_field_bank_account_number").subscribe(function (value) {
              return _this2.uiElementService.presentToast(value);
            });
          } else if (!this.payourRequest.bank_code || !this.payourRequest.bank_code.length) {
            this.translate.get("err_field_bank_code").subscribe(function (value) {
              return _this2.uiElementService.presentToast(value);
            });
          } else if (!this.payourRequest.amount || this.payourRequest.amount > this.balance || this.payourRequest.amount < 0) {
            this.translate.get("err_field_amount").subscribe(function (value) {
              return _this2.uiElementService.presentToast(value);
            });
          } else {
            this.translate.get(["just_moment", "something_wrong"]).subscribe(function (values) {
              ...
              _this2.subscriptions.push(_this2.apiService.walletTransfer(_this2.payourRequest).subscribe(function (res) {
                src_models_helper_models__WEBPACK_IMPORTED_MODULE_6__["Helper"].setBankDetail({
                  bank_name: _this2.payourRequest.bank_name,
                  bank_account_name: _this2.payourRequest.bank_account_name,
                  bank_account_number: _this2.payourRequest.bank_account_number
                });
                ...
                _this2.uiElementService.presentToast(values["something_wrong"]);
    ...
    SendToBankPage.ctorParameters = function () {
      return [{
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"], _services_common_ui_elements_service__WEBPACK_IMPORTED_MODULE_4__["UiElementsService"], _services_network_api_service__WEBPACK_IMPORTED_MODULE_5__["ApiService"]])], SendToBankPage);
    /***/
  },

  /***/
  "./src/models/payout-request.models.ts": function srcModelsPayoutRequestModelsTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PayoutRequest", function () {
    ...
    var PayoutRequest = function PayoutRequest() {
      _classCallCheck(this, PayoutRequest);

      var savedBankDetail = _helper_models__WEBPACK_IMPORTED_MODULE_0__["Helper"].getBankDetail();
