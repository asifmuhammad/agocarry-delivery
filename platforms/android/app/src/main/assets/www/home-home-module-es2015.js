...
/* harmony import */ var src_models_profile_models__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/models/profile.models */ "./src/models/profile.models.ts");
...
/* harmony import */ var src_models_insight_order_models__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/models/insight-order.models */ "./src/models/insight-order.models.ts");
...
let HomePage = class HomePage {
    constructor(route, navCtrl, translate, myEvent, uiElementService, apiService, maps) {
        this.route = route;
    ...
    ngOnInit() {
        this.subscriptions.push(this.myEvent.getLocationObservable().subscribe(location => {
            if (this.initialized && location != null)
                this.plotMarker(new google.maps.LatLng(Number(location.latitude), Number(location.longitude)));
        }));
    ...
    ionViewDidEnter() {
        ...
        if (!this.initialized) {
            let selectedLocation = src_models_helper_models__WEBPACK_IMPORTED_MODULE_4__["Helper"].getLocation();
            let mapLoaded = this.maps.init(this.mapElement.nativeElement, this.pleaseConnect.nativeElement, selectedLocation).then(() => {
                ...
                if (selectedLocation != null)
                    this.plotMarker(new google.maps.LatLng(Number(selectedLocation.latitude), Number(selectedLocation.longitude)));
            }).catch(err => console.log(err));
            mapLoaded.catch(err => console.log(err));
        }
        let recheck = window.localStorage.getItem("recheck");
        if (recheck != null)
            this.checkDeliveryRequest();
...
HomePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_10__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateService"], _services_events_my_events_service__WEBPACK_IMPORTED_MODULE_6__["MyEventsService"],
        _services_common_ui_elements_service__WEBPACK_IMPORTED_MODULE_7__["UiElementsService"], _services_network_api_service__WEBPACK_IMPORTED_MODULE_8__["ApiService"], _services_network_google_maps_service__WEBPACK_IMPORTED_MODULE_9__["GoogleMapsService"]])
], HomePage);
