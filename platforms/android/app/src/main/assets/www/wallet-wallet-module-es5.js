...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["wallet-wallet-module"], {
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/wallet/wallet.page.html": function node_modulesRawLoaderDistCjsJsSrcAppWalletWalletPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/wallet/wallet-routing.module.ts": function srcAppWalletWalletRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/wallet/wallet.module.ts": function srcAppWalletWalletModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/wallet/wallet.page.scss": function srcAppWalletWalletPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/wallet/wallet.page.ts": function srcAppWalletWalletPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var WalletPage = /*#__PURE__*/function () {
      function WalletPage(navCtrl, translate, uiElementService, apiService) {
      ...
      _createClass(WalletPage, [{
        ...
        value: function refreshBalance() {
          ...
          this.subscriptions.push(this.apiService.getBalance().subscribe(function (res) {
            if (res.balance != _this.balance || (!_this.transactions || !_this.transactions.length) && res.balance != 0) {
              _this.transactions = [];
              _this.isLoading = true;

              _this.subscriptions.push(_this.apiService.getTransactions().subscribe(function (res) {
                return _this.handleTransactionRes(res);
              }, function (err) {
                return _this.handleTransactionErr(err);
              }));
            } else {
        ...
        key: "handleTransactionRes",
        value: function handleTransactionRes(res) {
        ...
        key: "handleTransactionErr",
        value: function handleTransactionErr(err) {
        ...
        key: "doInfiniteTransactions",
        value: function doInfiniteTransactions(event) {
          var _this2 = this;
          ...
          if (this.nextUrl == null) {
            ...
            this.subscriptions.push(this.apiService.getURL(this.nextUrl).subscribe(function (res) {
              if (res && res.data && res.data.length) {
                ...
                try {
                  for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                    ...
                    _this2.apiService.setupTransaction(trans);
                  }
                } catch (err) {
                  _iterator2.e(err);
                } finally {
              ...
              _this2.handleTransactionRes(res);
            }, function (err) {
              return _this2.handleTransactionErr(err);
            }));
          }
        }
      }, {
        key: "navBankTransfer",
        value: function navBankTransfer() {
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"], _services_common_ui_elements_service__WEBPACK_IMPORTED_MODULE_4__["UiElementsService"], _services_network_api_service__WEBPACK_IMPORTED_MODULE_5__["ApiService"]])], WalletPage);
    /***/
  }
}]);
