    ...
    var VerificationPage = /*#__PURE__*/function () {
      ...
      _createClass(VerificationPage, [{
        ...
        value: function loginUser(token) {
          ...
          this.translate.get('just_moment').subscribe(function (value) {
            ...
            _this2.apiService.loginUser({
              token: token,
              role: src_models_constants_models__WEBPACK_IMPORTED_MODULE_9__["Constants"].ROLE_DELIVERY
            }).subscribe(function (res) {
              _this2.uiElementService.dismissLoading();

              _this2.myEvent.setLoginData(res);
        ...
        value: function sendOtpBrowser(phone) {
          ...
          firebase_app__WEBPACK_IMPORTED_MODULE_8__["auth"]().signInWithPhoneNumber(phone, this.recaptchaVerifier).then(function (confirmationResult) {
        ...
        value: function retryOld(credential) {
          ...
          this.translate.get('verifying_otp').subscribe(function (value) {
            ...
            firebase_app__WEBPACK_IMPORTED_MODULE_8__["auth"]().signInAndRetrieveDataWithCredential(credential).then(function (info) {
