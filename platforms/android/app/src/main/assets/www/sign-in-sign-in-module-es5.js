...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sign-in-sign-in-module"], {
  ...
  "./src/app/sign-in/sign-in.page.ts": function srcAppSignInSignInPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SignInPage = /*#__PURE__*/function () {
      function SignInPage(config, navCtrl, myEvent, uiElementService, apiService, translate, alertCtrl, platform) {
      ...
      _createClass(SignInPage, [{
        ...
        value: function alertPhone() {
          ...
          this.translate.get(['alert_phone', 'no', 'yes']).subscribe(function (text) {
            _this3.phoneNumberFull = "+" + _this3.countryCode + +src_models_helper_models__WEBPACK_IMPORTED_MODULE_9__["Helper"].formatPhone(_this3.phoneNumber);

            _this3.alertCtrl.create({
              header: _this3.phoneNumberFull,
        ...
        value: function checkIfExists() {
          ...
          this.translate.get('just_moment').subscribe(function (value) {
            _this4.uiElementService.presentLoading(value);

            _this4.apiService.checkUser({
              mobile_number: _this4.phoneNumberFull,
              role: src_models_constants_models__WEBPACK_IMPORTED_MODULE_8__["Constants"].ROLE_DELIVERY
              ...
              var navigationExtras = {
                queryParams: {
                  phoneNumberFull: _this4.phoneNumberFull
                }
              };

              _this4.navCtrl.navigateForward(['./verification'], navigationExtras);
            }, function (err) {
              console.log(err);
              ...
              var navigationExtras = {
                queryParams: {
                  code: _this4.countryCode,
                  phone: _this4.phoneNumber
                }
              };

              _this4.navCtrl.navigateForward(['./register'], navigationExtras);
            });
          });
        }
      }]);
